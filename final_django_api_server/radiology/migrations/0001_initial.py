    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(db_column='patient_id', on_delete=django.db.models.deletion.CASCADE, to='doctor.patient')),
                ('radiologic', models.ForeignKey(db_column='radiologic_id', on_delete=django.db.models.deletion.RESTRICT, to='radiology.radiology')),
                ('study', models.ForeignKey(blank=True, db_column='study_uid', null=True, on_delete=django.db.models.deletion.SET_NULL, to='radiology.dicomstudy')),
            ],
            options={

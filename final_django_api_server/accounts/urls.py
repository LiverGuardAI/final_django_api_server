...
from .views import LoginView, LogoutView, DoctorLoginView, AdministrationLoginView, RadiologyLoginView, StaffListView, PublicDutyScheduleView
...
from .views import DutyScheduleViewSet

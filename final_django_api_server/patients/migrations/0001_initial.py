    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_image', models.CharField(blank=True, max_length=1000, null=True)),
                ...
                ('color_class1', models.CharField(blank=True, max_length=50, null=True)),
                ('color_class2', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('etc_otc_name', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linked_patient_id', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedule_type', accounts.fields.ScheduleTypeField(blank=True, choices=[('DAILY', '매일'), ('WEEKLY', '매주'), ('CUSTOM', '사용자 정의')], max_length=20, null=True)),
                ...
                ('meal_timing', accounts.fields.MealTimingField(blank=True, choices=[('BEFORE_MEAL', '식전'), ('AFTER_MEAL', '식후'), ('WITH_MEAL', '식사와 함께'), ('ANYTIME', '상관없음')], max_length=20, null=True)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('med', models.ForeignKey(db_column='med_id', on_delete=django.db.models.deletion.CASCADE, to='patients.medicationdetail')),
        ...
        migrations.AddField(
            ...
            name='pill_info',
            field=models.ForeignKey(db_column='item_seq', on_delete=django.db.models.deletion.RESTRICT, to='patients.pillinfo'),
        ),
        migrations.AddField(
            model_name='medicationdetail',
            name='pres',
            field=models.ForeignKey(db_column='pres_id', on_delete=django.db.models.deletion.CASCADE, to='patients.prescription'),
        ),
        migrations.AddField(
            model_name='prescription',
            name='profile',
            field=models.ForeignKey(db_column='profile_id', on_delete=django.db.models.deletion.CASCADE, to='patients.userprofile'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alcohol_freq', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', accounts.fields.MedicationStatusField(choices=[('TAKEN', '복용함'), ('SKIPPED', '건너뜀'), ('MISSED', '누락'), ('SCHEDULED', '예정')], max_length=20)),
                ('skip_reason', models.TextField(blank=True, null=True)),
                ('scheduled_dosage', models.CharField(blank=True, max_length=50, null=True)),
                ('actual_dosage', models.CharField(blank=True, max_length=50, null=True)),
                ('notes', models.TextField(blank=True, null=True)),
                ('side_effects', models.JSONField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('med', models.ForeignKey(db_column='med_id', on_delete=django.db.models.deletion.CASCADE, to='patients.medicationdetail')),
                ('schedule', models.ForeignKey(db_column='schedule_id', on_delete=django.db.models.deletion.CASCADE, to='patients.medicationschedule')),
                ('profile', models.ForeignKey(db_column='profile_id', on_delete=django.db.models.deletion.CASCADE, to='patients.userprofile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('adherence_id', models.BigAutoField(primary_key=True, serialize=False)),
                ...
                ('adherence_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('on_time_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_drug_name', models.CharField(blank=True, max_length=200, null=True)),
                ('conflict_drug_name', models.CharField(blank=True, max_length=200, null=True)),
                ('violated_dur', models.ForeignKey(db_column='violated_dur_id', on_delete=django.db.models.deletion.RESTRICT, to='patients.durcontraindication')),
                ('profile', models.ForeignKey(db_column='profile_id', on_delete=django.db.models.deletion.CASCADE, to='patients.userprofile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disease_code', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger_agent', models.CharField(blank=True, max_length=100, null=True)),
                ('reaction_desc', models.CharField(blank=True, max_length=200, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('profile', models.ForeignKey(db_column='profile_id', on_delete=django.db.models.deletion.CASCADE, to='patients.userprofile')),
            ],
